...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // Mac OS Base layer
  [_ML] = KEYMAP(
    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    _____,    \
    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,              __v__,    \
    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    _____,              __v__,    \
    __v__,    _____,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    _____,    __v__,    __v__,    \
  ...
  [_FL] = KEYMAP(
    ...
    __v__,    __v__,    __v__,                                  _____,                                  __v__,    __v__,    KC_HOME,  KC_PGDN,  KC_END    ),
  ...
  [_CL] = KEYMAP(
    ...
    KC_CAPS,  _____,    RGB_HUD,  RGB_SAD,  RGB_VAD,  _____,    _____,    KC_P0,    KC_PDOT,  KC_PENT,  KC_PPLS,  _____,    _____,    __v__,    TG(_CL),  \
    _____,    _____,    _____,                                  RGB_MOD,                                _____,    _____,    __v__,    __v__,    __v__     )
};
