...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ML] = KEYMAP(
    ...
    __v__,    __v__,    __v__,    KC_F,     KC_P,     KC_G,     KC_J,     KC_L,     KC_U,     KC_Y,     KC_SCLN,  __v__,    __v__,              __v__,    \
    __v__,    __v__,    KC_R,     KC_S,     KC_T,     KC_D,     __v__,    KC_N,     KC_E,     KC_I,     KC_O,     __v__,    _____,              __v__,    \
    __v__,    _____,    __v__,    __v__,    __v__,    __v__,    KC_B,     KC_K,     __v__,    __v__,   __v__,     __v__,    _____,    __v__,    _____,    \
    __v__,    __v__,    __v__,                                  __v__,                                  __v__,    __v__,    _____,    __v__,    __v__     ),
