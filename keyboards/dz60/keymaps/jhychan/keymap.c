...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = KEYMAP(
    ...
    KC_LSPO,  MO(_FN),  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSPC,  MO(_OH),  \
    _____,    MO(_OH),  KC_RALT,            KC_LSFT,            KC_APP,             KC_SPC,             KC_RGUI,  MO(_FN),  _____,    TG(_GL),  _____     ),
