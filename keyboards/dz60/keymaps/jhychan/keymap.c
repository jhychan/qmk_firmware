...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = KEYMAP(
    ...
    MO(_OH),  KC_LSPO,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSPC,  MO(_OH),  \
    _____,    MO(_FN),  KC_LALT,            KC_LSFT,            KC_APP,             KC_SPC,             KC_RGUI,  MO(_FN),  _____,    TG(_GL),  _____     ),
  ...
  [_GL] = KEYMAP(
    ...
    KC_LCTL,  KC_LSFT,  __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,              __v__,    KC_RCTL,  \
    _____,    KC_LGUI,  KC_LALT,            KC_SPC,             KC_SPC,             KC_SPC,             KC_RALT,  KC_RGUI,  _____,    __v__,    _____     ),

  // One-handed access layer
  [_OH] = KEYMAP(
    ...
    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,                        __v__,    \
    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,              __v__,    __v__,    \
    _____,    __v__,    __v__,              KC_SPC,             __v__,              __v__,              __v__,    __v__,    _____,    __v__,    _____     ),
  ...
  [_FN] = KEYMAP(
    ...
    _____,    __v__,    _____,    KC_APP,   _____,    _____,    _____,    _____,    _____,    _____,    KC_END,   KC_PGDN,            __v__,    _____,    \
    _____,    __v__,    __v__,              __v__,              KC_CAPS,            _____,              __v__,    __v__,    _____,    __v__,    _____     ),
  ...
  [_CL] = KEYMAP(
    ...
    _____,    _____,    _____,    KC_VOLD,  KC_MUTE,  _____,    _____,    _____,    BL_DEC,   _____,    KC_MRWD,  KC_MFFD,                      _____,    \
