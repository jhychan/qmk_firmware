...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = KEYMAP(
    ...
    KC_LSPO,  MO(_OH),  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSPC,  MO(_OH),  \
  ...
  [_GL] = KEYMAP(
    ...
    KC_LSFT,  KC_LCTL,  __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,    __v__,              __v__,    KC_RCTL,  \
